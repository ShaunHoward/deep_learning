...
cmd:text('Example:')
cmd:text('$> th digits2.lua --batchSize 128 --momentum 0.5')
cmd:text('Options:')
...
cmd:option('--lecunlcn', true, 'apply lecun local contrast normalization')
...
-- convert to batchsize x # features and convert types
